...
-- CreateEnum
CREATE TYPE "FeeType" AS ENUM ('TUITION', 'TRANSPORT', 'ACTIVITY', 'UNIFORM', 'EXAM', 'OTHER');

-- CreateEnum
CREATE TYPE "Day" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY');

-- CreateEnum
CREATE TYPE "ExamType" AS ENUM ('FORMATIVE', 'SUMMATIVE');

-- CreateEnum
CREATE TYPE "ClassLevel" AS ENUM ('PRE_PRIMARY', 'LOWER_PRIMARY', 'UPPER_PRIMARY', 'JUNIOR_SECONDARY');
...
CREATE TABLE "Class" (
    ...
    "name" TEXT NOT NULL,
    "section" TEXT,
    "level" "ClassLevel" NOT NULL DEFAULT 'JUNIOR_SECONDARY',
...
CREATE TABLE "Exam" (
    ...
    "examType" "ExamType" NOT NULL DEFAULT 'SUMMATIVE',
    "date" TIMESTAMP(3),
